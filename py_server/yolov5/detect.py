...
from utils.plots import Annotator, colors, save_one_box, show_Image, config
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if 'mp4' in source:
                            ...
                            annotator.box_label_Image(xyxy, label, color=colors(c, True))
                ...
                if 'mp4'in source:
                    ...
                    show_Image(annotator.im)
                    config.image_car_arr.clear()
                    config.complete_car_arr.clear()
                    config.real_car_arr.clear()
                    config.numberOfCarImage = 0
            ...
            if view_img:
                ...
                # cv2.line(im0, (25, pos_linha), (1200, pos_linha), (255, 127, 0), 3)
